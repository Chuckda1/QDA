...
export class Scheduler {
  ...
  private tick(): void {
    ...
    // QUIET: 16:00:00 ET - 09:24:59 ET → do NOT process trading decisions, but DO log HB/status-pulse and accept /status
    ...
    if (isActiveHours) {
      ...
      if (this.governor.getMode() !== "QUIET") {
        console.log(`[Scheduler] Switching to QUIET mode (ET: ${hour}:${minute.toString().padStart(2, '0')}) - bars skipped, HB logs continue, /status works`);
